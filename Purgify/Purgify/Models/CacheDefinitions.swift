...
enum CacheDefinitions {
    static let all: [CacheDefinition] = [
        ...
        CacheDefinition(nameKey: "cache.rnBuild", detailKey: "cache.rnBuild.detail", path: "~", icon: "hammer.fill", iconColor: Color(red: 0.13, green: 0.68, blue: 0.45), risk: .moderate, subItemMode: .vms, vmScanType: .reactNativeBuild),
        CacheDefinition(nameKey: "cache.rustProject", detailKey: "cache.rustProject.detail", path: "~", icon: "shippingbox.fill", iconColor: Color(red: 0.81, green: 0.26, blue: 0.17), risk: .moderate, subItemMode: .vms, vmScanType: .rustProject),
        CacheDefinition(nameKey: "cache.flutterProject", detailKey: "cache.flutterProject.detail", path: "~", icon: "wind", iconColor: Color(red: 0.33, green: 0.77, blue: 0.97), risk: .moderate, subItemMode: .vms, vmScanType: .flutterProject),
        CacheDefinition(nameKey: "cache.webFrontend", detailKey: "cache.webFrontend.detail", path: "~", icon: "globe", iconColor: Color(red: 0.00, green: 0.60, blue: 0.90), risk: .moderate, subItemMode: .vms, vmScanType: .webFrontendProject),
        CacheDefinition(nameKey: "cache.iosProject", detailKey: "cache.iosProject.detail", path: "~", icon: "iphone", iconColor: Color(red: 0.45, green: 0.45, blue: 0.50), risk: .moderate, subItemMode: .vms, vmScanType: .iosPodsProject),
        CacheDefinition(nameKey: "cache.androidProject", detailKey: "cache.androidProject.detail", path: "~", icon: "candybarphone", iconColor: Color(red: 0.24, green: 0.86, blue: 0.52), risk: .moderate, subItemMode: .vms, vmScanType: .androidNativeProject),
        CacheDefinition(nameKey: "cache.pythonProject", detailKey: "cache.pythonProject.detail", path: "~", icon: "terminal.fill", iconColor: Color(red: 0.22, green: 0.47, blue: 0.67), risk: .moderate, subItemMode: .vms, vmScanType: .pythonProject),
