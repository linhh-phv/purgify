...
class LocalizationManager: ObservableObject {
    ...
    private let strings: [AppLanguage: [String: String]] = [
        ...
        .en: [
            ...
            "cache.diagnosticReports.detail":
                "Crash reports and hang reports generated by macOS and apps when something goes wrong.\n\n" +
                "These are informational only — they don't affect any running app.\n\n" +
                "The only effect: you lose historical crash reports that could help Apple or developers debug past issues.",
        ...
        .vi: [
            ...
            "cache.diagnosticReports": "Diagnostic Reports",
            "cache.diagnosticReports.detail":
                "Báo cáo crash và hang của macOS cùng các app khi có lỗi.\n\n" +
                "Chỉ mang tính tham khảo — không ảnh hưởng đến app đang chạy.\n\n" +
                "Tác động duy nhất: mất lịch sử crash report có thể dùng để debug lỗi cũ với Apple hoặc developer.",
