...
3. `READ gitnexus://repo/purgify/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/purgify/context` | Codebase overview, check index freshness |
| `gitnexus://repo/purgify/clusters` | All functional areas |
| `gitnexus://repo/purgify/processes` | All execution flows |
| `gitnexus://repo/purgify/process/{name}` | Step-by-step execution trace |
